...
export default function SystemGraphNode({ data, selected }) {
    return (
        <div
        ...
        >
            ...
            <p className="text-[10px] uppercase tracking-[0.24em] opacity-70">system</p>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
                ...
                {data.compromised && (
                    <span className="rounded-full border border-danger/20 bg-danger/10 px-2 py-1 text-[10px] uppercase tracking-[0.16em] text-red-200">
                        impacted
                    </span>
                )}
                {data.privileged && (
